  ...
  describe('getPresetName', () => {
    it('returns preset name when found', () => {
      ...
      appData.data.presets = [
        { id: 'preset-1', name: 'Sunset', color: { hsv: { h: 30, s: 100, v: 100 } } },
        { id: 'preset-2', name: 'Ocean', color: { hsv: { h: 200, s: 80, v: 90 } } }
      ]
  ...
  describe('getControllerInfo', () => {
    it('returns controller info when found', () => {
      ...
      controllersStore.data = [
        { id: 'ctrl-1', hostname: 'Kitchen', ip_address: '192.168.1.10', online: true, icon: 'lightbulb' },
        { id: 'ctrl-2', hostname: 'Bedroom', ip_address: '192.168.1.11', online: false, icon: 'led-strip' }
      ]
    ...
    it('handles string and number IDs equally', () => {
      const controllersStore = useControllersStore()
      controllersStore.data = [
        { id: '123', hostname: 'Test', ip_address: '192.168.1.5', online: true, icon: 'light' }
      ]
