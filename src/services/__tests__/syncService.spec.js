...
const { useControllersStore } =
  await import("../../stores/controllersStore.js");
...
describe("SyncService", () => {
  ...
  describe("collectDataFromController", () => {
    ...
    it("should collect valid groups", () => {
      const allData = { presets: [], scenes: [], groups: [], controllers: [] };
      const jsonData = {
        groups: [{ id: "group1", name: "Group 1", ts: 1000 }],
      };
  ...
  describe("Integration - Full Sync Flow", () => {
    it("should complete successful sync with multiple controllers", async () => {
      const consolidatedData = {
        ...
        scenes: [{ id: "scene1", name: "Scene 1", items: [], ts: 1000 }],
        groups: [],
      };
      ...
      apiService.getDataFromController
        ...
        .mockResolvedValueOnce({
          jsonData: {
            presets: [{ id: "preset1", name: "Preset A", ts: 1000 }],
            scenes: [],
            groups: [],
          },
          error: null,
  ...
  describe("Distributed Sync Locking", () => {
    ...
    describe("Lock Acquisition - No Existing Locks", () => {
      it("should acquire locks on all 5 controllers when none exist", async () => {
        ...
        const result =
          await syncService.acquireDistributedLocks(fiveControllers);
    ...
    describe("Lock Verification - Missing Lock on Readback", () => {
      it("should back out and retry when lock verification fails on one controller", async () => {
        ...
        apiService.getDataFromController
          ...
          .mockResolvedValueOnce({
            // ctrl-3 - MISSING OUR LOCK
            jsonData: {
              "sync-lock": { id: "other-client", ts: NOW },
              presets: [],
              scenes: [],
              groups: [],
            },
        ...
        const result = await syncService.verifyDistributedLocks(
          fiveControllers,
          "ctrl-1",
        );
  ...
  describe("Data Consolidation and Reconciliation", () => {
    ...
    describe("Scene Consolidation", () => {
      ...
      it("should merge scene items arrays, deduplicating by ID", () => {
        ...
        const item1 = consolidated.scenes[0].items.find(
          (i) => i.id === "item1",
        );
      ...
      it("should drop scenes with empty name", () => {
        ...
        expect(
          consolidated.scenes.find((s) => s.id === "scene2"),
        ).toBeUndefined();
      });
    ...
    describe("Full Sync with Data Issues", () => {
      ...
      it("should clean and sync data across all controllers using real data patterns", async () => {
        ...
        apiService.getHosts.mockResolvedValue({
          jsonData: {
            hosts: [
              {
                id: "ctrl-1",
                hostname: "test-device-1765885988669",
                ip_address: "192.168.29.31",
                visible: true,
              },
              {
        ...
        const consolidatedPresets = [
          {
            color: { raw: { ww: 542, r: 431, b: 303, cw: 760, g: 588 } },
            name: "Test",
            id: "10966439-655712395",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 66, v: 83, h: 301, ct: 0 } },
            name: "Pink",
            id: "10966439-624801566",
            favorite: true,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 90, v: 89, h: 241, ct: 0 } },
            name: "Blau",
            id: "10966439-685623466",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 90, v: 89, h: 113, ct: 0 } },
            name: "Grün",
            id: "10966439-737984847",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 88, v: 89, h: 184, ct: 0 } },
            name: "Petrol",
            id: "10966439-515417152",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { raw: { ww: 1023, r: 1023, b: 1023, cw: 1023, g: 1023 } },
            name: "RAW max",
            id: "2827530-419906442",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 0, v: 100, h: 0, ct: 0 } },
            name: "Voll",
            id: "10964518-938075610",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 0, v: 0, h: 0, ct: 0 } },
            name: "Aus",
            id: "6737456-819298884",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 56, v: 23, h: 247, ct: 0 } },
            name: "Nachtblau",
            id: "10964518-122507691",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 0, v: 47, h: 0, ct: 0 } },
            name: "eher so mittel",
            id: "6737456-248766862",
            favorite: true,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 37, v: 43, h: 0, ct: 0 } },
            name: "dunkelrot",
            id: "4035244248-168429429",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
          {
            color: { hsv: { s: 28, v: 55, h: 0, ct: 0 } },
            name: "test",
            id: "6668181-927384476",
            favorite: false,
            ts: 2147483647,
            icon: "palette",
          },
        ...
        const consolidatedScenes = [
          {
            ...
            settings: [
              {
                transition: { d: 0, t: 0, s: 0, cmd: null, q: null, r: false },
                color: { hsv: { s: 0, v: 100, h: 0, ct: 2700 } },
            ...
            name: "Snapshot 19:23:26",
            ts: 2147483647,
            id: "6668181-227004589",
            group_id: "477228760-883885021",
            favorite: false,
            icon: "scene",
          },
          {
            ...
            settings: [
              {
                transition: { d: 0, t: 0, s: 0, cmd: null, q: null, r: false },
                color: { hsv: { s: 15, v: 49, h: 0, ct: 0 } },
                controller_id: "6737456",
                pos: 0,
              },
            ],
            name: "An",
            ts: 2147483647,
            id: "3090114465-796372243",
            group_id: "6737456-706129657",
            favorite: false,
            icon: "scene",
          },
          {
        ...
        const consolidatedGroups = [
          {
            controller_ids: ["2827530", "4599343"],
            name: "Büro",
            ts: 2147483647,
            id: "477228760-883885021",
            icon: "light_groups",
          },
          {
            controller_ids: ["6737456"],
            name: "Schlafzimmer",
            ts: 2147483647,
            id: "6737456-706129657",
            icon: "light_groups",
          },
          {
            controller_ids: ["390774", "1451258"],
            name: "Terasse",
            ts: 2147483647,
            id: "4035244248-578276531",
            icon: "light_groups",
          },
          {
            controller_ids: ["15603867", "2826766", "12742997"],
            name: "Wohnzimmer",
            ts: 2147483647,
            id: "2827530-876452071",
            icon: "light_groups",
          },
          {
            controller_ids: ["2827530"],
            name: "TestGroup3",
            ts: 1234567892,
            id: "test-789",
            icon: "light_groups",
          ...
          {
            controller_ids: ["390774", "1451258"],
            name: "TestAPI-1-UPDATED",
            ts: 1234567890,
            id: "test-api-1",
            icon: "light_groups",
          },
          {
            controller_ids: ["1451258"],
            name: "TestAPI-2",
            ts: 1234567891,
            id: "test-api-2",
            icon: "light_groups",
        ...
        apiService.getDataFromController
          .mockResolvedValueOnce({
            // ctrl-1: 192.168.29.31 - has invalid preset with null name/id
            jsonData: {
          ...
          .mockResolvedValueOnce({
            // ctrl-2: 192.168.29.115 - has 12 presets with duplicates
            jsonData: {
              "sync-lock": { id: "", ts: 0 },
              ...
              presets: [
                ...
                {
                  color: {
                    raw: { ww: 1023, r: 1023, b: 1023, cw: 1023, g: 1023 },
                  },
                  name: "RAW max",
                  id: "2827530-419906442",
                  favorite: false,
          ...
          .mockResolvedValueOnce({
            // ctrl-3: 192.168.29.121 - has duplicate IDs (shares many with ctrl-2)
            jsonData: {
              "sync-lock": { id: "", ts: 0 },
              presets: [
                {
        ...
        const bueroGroup = allPayloadGroups.find(
          (g) => g.id === "477228760-883885021",
        );
        ...
        expect(countPayloadItems(payload1, "scenes")).toBe(
          countPayloadItems(payload2, "scenes"),
        );
        expect(countPayloadItems(payload2, "scenes")).toBe(
          countPayloadItems(payload3, "scenes"),
        );
        expect(countPayloadItems(payload1, "groups")).toBe(
          countPayloadItems(payload2, "groups"),
        );
        expect(countPayloadItems(payload2, "groups")).toBe(
          countPayloadItems(payload3, "groups"),
        );
      });
      ...
      it("should send consolidated data to fix controller-specific issues", async () => {
        ...
        const hasInvalidGroup = groups1.some(
          (g) => g.id === null || g.name === null,
        );
